...
if ($brand == null) {
    header("location: brandPage.php?message=Geen merk gevonden.");
}
...
if ($user->role != "admin") {
    header("Location: brandPage.php?adminCheck=false");
    exit;
}
    ...
    <body>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div class="navbar-nav">
                                ...
                                <a class="btn admin-nav-link <?= in_array($currentPage, ['setPage.php', 'setInsert.php', 'setEdit.php', 'setDelete.php'], true) ? 'active' : '' ?>" id="navbarSetsPage"
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            ...
                            <div class="navbar-nav">
                                <a class="btn admin-nav-link <?= in_array($currentPage, ['brandPage.php', 'brandInsert.php', 'brandEdit.php', 'brandDelete.php'], true) ? 'active' : '' ?>" id="navbarbrandPage" href="brandPage.php">
                                    <h5>Merk</h5>
                                </a>
                            </div>
                        </div>
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            ...
                            <div class="navbar-nav">
                                <a class="btn admin-nav-link <?= in_array($currentPage, ['themePage.php', 'themeInsert.php', 'themeEdit.php', 'themeDelete.php'], true) ? 'active' : '' ?>" id="navbarAdminpage" href="themePage.php">
                                    <h5>Thema</h5>
                                </a>
                            </div>
                        </div>
        ...
        <div>
            ...
            <style>
                body {
                    background: #0d1820;
                    background-image: radial-gradient(circle at 32% 60%, rgba(151, 168, 66, 0.4), transparent 30%);
                }
            </style>
        </div>
    </body>
